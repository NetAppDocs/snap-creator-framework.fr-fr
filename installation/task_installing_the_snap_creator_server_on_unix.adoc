...
Running
----
. Validez le démarrage de l'interface graphique du Snap Creator Framework en accédant à l'hôte local sur le port spécifié (par exemple, https://10.12.123.123:8443)+[].
+
