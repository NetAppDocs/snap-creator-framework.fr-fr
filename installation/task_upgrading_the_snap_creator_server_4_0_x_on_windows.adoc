...
Vous devez également valider le démarrage de l'interface graphique de Snap Creator Framework en accédant à l'hôte local sur le port spécifié +(https://IP_address:gui_port)+[].
