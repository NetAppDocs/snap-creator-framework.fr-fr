...
. [[treizième étape]]Sur la page de détails de l'instantané, spécifiez les informations de configuration de l'instantané :
+
|===
| Pour ce champ... | Procédez comme ça... 
...
.. Les instructions se trouvent à l'étape suivante<<thirteenth-step,13>>.
